...
class Searchform(FlaskForm):
    ram =  SelectField('RAM', choices = [(4, '4'), (8, '8'), (16, '16') , (32, '32')])
    gpu = SelectField('GPU', choices = [(1, '1'), (2, '2'), (3, '3')])
    weight = SelectField('Weight', choices = [(1.8, '1.8'), (2.3, '2.3'), (2.7, '2.7')])
    typename = SelectField('TypeName', choices = [('gaming', 'gaming'), ('notebook', 'notebook'), ('ultrabok', 'ultrabok'), ('workstation', 'workstation')])
